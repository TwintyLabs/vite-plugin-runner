...
```bash
npm install -D @twintylabs/vite-plugin-runner
```
...
```typescript
// vite.config.ts
import { run } from "@twintylabs/vite-plugin-runner";
...
MIT — [TwintyLabs](https://github.com/twintylabs)